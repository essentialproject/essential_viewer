...
<xsl:stylesheet version="2.0" xpath-default-namespace="http://protege.stanford.edu/xml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xslt" xmlns:pro="http://protege.stanford.edu/xml" xmlns:eas="http://www.enterprise-architecture.org/essential" xmlns:functx="http://www.functx.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ess="http://www.enterprise-architecture.org/essential/errorview">
		...
		<xsl:choose>
			<xsl:when test="string-length($viewScopeTermIds) > 0">
				...
				<xsl:call-template name="BuildPage">
					...
					<xsl:with-param name="inScopeAppCaps" select="$allAppCaps[own_slot_value[slot_reference = 'element_classified_by']/value = $viewScopeTerms/name]"/>
				</xsl:call-template>
			</xsl:when>
			<xsl:otherwise>
				<xsl:call-template name="BuildPage">
					<xsl:with-param name="inScopeAppCaps" select="$allAppCaps"/>
				</xsl:call-template>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<p>
								<xsl:value-of select="eas:i18n('Please click on one of the Application Capabilities below to navigate to the required view.')"/>
							</p>
							...
							<div class="AlphabetQuickJumpLinks hidden-xs">
								...
								<xsl:variable name="anInFocusInstances" select="$inScopeAppCaps"></xsl:variable>
							...
							<xsl:call-template name="Index">
								...
								<xsl:with-param name="inScopeInstances" select="$inScopeAppCaps"/>
							</xsl:call-template>
	...
	<xsl:template name="Index">
		...
		<!-- Application Capabilities START HERE -->
		<div class="catalogItems">
			...
			<!-- Application Capabilities END HERE -->
		</div>
