	...
	<xsl:template match="knowledge_base">
       ...
       function goBack() {
            ...
            <div>
                ...
                <xsl:attribute name="data-num">{{getScore score}}</xsl:attribute>  
                ...
                <div class="appCard_Middle">
                    <div class="appCard_Section50pc appCard_Divider alert-success"><xsl:attribute name="style">background-color:{{colour}}</xsl:attribute>
