...
<xsl:stylesheet version="2.0" xpath-default-namespace="http://protege.stanford.edu/xml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xslt" xmlns:pro="http://protege.stanford.edu/xml" xmlns:eas="http://www.enterprise-architecture.org/essential" xmlns:functx="http://www.functx.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ess="http://www.enterprise-architecture.org/essential/errorview">
	...
	<xsl:variable name="pageTitle">
		<xsl:value-of select="eas:i18n('Application Distribution Model')"/>
	</xsl:variable>
							...
							<div class="content-section">
								...
								<xsl:if test="count($modelSubject) = 1">
									...
									<div class="uml_key_container">
										...
										<span class="umlKeyTitle fontBlack small"><xsl:value-of select="eas:i18n('Key')"/>:</span>
										<div class="umlCircleBadge bg-aqua-100 text-white">I</div>
										<span class="umlCircleBadgeDescription small">
											<xsl:value-of select="eas:i18n('Internal')"/>
										</span>
										<div class="umlCircleBadge bg-darkblue-100  text-white">E</div>
										<span class="umlCircleBadgeDescription small">
									...
									<div class="umlModelViewport">
										<img class="umlImage" width="860px" src="{$imageFilename}" usemap="#unix" id="image" alt="UML Model"/>
