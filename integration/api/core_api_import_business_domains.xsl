...
<xsl:template match="node()" mode="businessDomains">
	<xsl:variable name="subDomains" select="$businessDomains[name=current()/own_slot_value[slot_reference='contained_business_domains']/value]"/>
