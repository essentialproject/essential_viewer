...
<xsl:variable name="techProduct" select="/node()/simple_instance[type='Technology_Product'][own_slot_value[slot_reference = 'stakeholders']/value]"/>
<xsl:variable name="a2r" select="/node()/simple_instance[type=('ACTOR_TO_ROLE_RELATION')][name=$techProduct/own_slot_value[slot_reference = 'stakeholders']/value]"/>
