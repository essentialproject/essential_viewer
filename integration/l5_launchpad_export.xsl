...
<xsl:stylesheet version="2.0" xmlns:fn="http://www.functx.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xalan="http://xml.apache.org/xslt" xmlns:pro="http://protege.stanford.edu/xml" xpath-default-namespace="http://protege.stanford.edu/xml" xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:eas="http://www.enterprise-architecture.org/essential">
  ...
  <xsl:variable name="dataRolesa2r" select="$a2r[name = $dataRoles/own_slot_value[slot_reference='act_to_role_to_role']/value]"/> 
   ...
   <xsl:variable name="applicationModules" select="/node()/simple_instance[type = ('Application_Provider')]"/>  
   <xsl:variable name="applicationAPIs" select="/node()/simple_instance[type = ('Application_Provider_Interface')]"/>  
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Table of Contents">
  <Table ss:ExpandedColumnCount="3" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="20">
    <Cell ss:Index="2"  ss:StyleID="s1037" ss:HRef="#'Application Modules'!A1"><Data
      ss:Type="String">Application Modules</Data></Cell>
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures information about the Application Modules used within the organisation</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="20"> 
    <Cell  ss:Index="2" ss:StyleID="s1037" ss:HRef="#'App Pro Interface'!A1"><Data
      ss:Type="String">App Pro Interface</Data></Cell>
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures information about the Application Interfaces used within the organisation</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="20">
    <Cell ss:Index="2" ss:StyleID="s1037" ss:HRef="#'Application Dependencies'!A1"><Data
      ss:Type="String">Application Dependencies</Data></Cell>
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures the information dependencies between applications; where information passes between applications and the method for passing the information</Data></Cell>
   </Row>
   <Row ss:Height="34"> 
    <Cell ss:Index="2" ss:StyleID="s1037" ss:HRef="#'App Interface Dependencies'!A1"><Data
      ss:Type="String">App Interface Dependencies</Data></Cell>
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures the information dependencies between applications using an app interface; where information passes between applications, the method for passing the information and the interface used</Data></Cell>
   </Row>
   <Row ss:Height="20">
   ...
   <Row ss:Height="20">
    ...
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Maps Applications to the Organisations that use them</Data></Cell>
   </Row>
   <Row ss:Height="20">
    <Cell ss:Index="2" ss:StyleID="s1037" ss:HRef="#Servers!A1"><Data
      ss:Type="String">Servers</Data></Cell>
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures the list of physical technology nodes deployed across the enterprise, and the IP address if available</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="20"> 
    <Cell ss:Index="2" ss:StyleID="s1037" ss:HRef="#'Application Module 2 Server'!A1"><Data
      ss:Type="String">Application Module to Server</Data></Cell>
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Maps the application modules to the servers that they are hosted on, with the environment</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="20"> 
    <Cell ss:Index="2" ss:StyleID="s1037" ss:HRef="#'App Interface to Server'!A1"><Data
      ss:Type="String">Application Interface to Server</Data></Cell>
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Maps the application interfaces to the servers that they are hosted on, with the environment</Data></Cell>
   </Row>
   <Row ss:Height="20">
   ...
   <Row ss:Height="20">
    <Cell ss:Index="2" ss:StyleID="s1128" ss:HRef="#'Physical Proc 2 App and Service'!A1"><Data
      ss:Type="String">Physical Process 2 App via Service</Data></Cell>
    <Cell ss:StyleID="s1025"><Data ss:Type="String">Maps the Physical Business Process to the Application used and the Service it is used to provide</Data></Cell>
   </Row>
	<Row ss:Height="20">
   ...
   <Row ss:Height="20">
    ...
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Maps Technology Products to the Organisations that use them</Data></Cell>
   </Row>

   <Row ss:AutoFitHeight="0" ss:Height="20"> 
      <Cell ss:Index="2" ss:StyleID="s1128" ss:HRef="#'App Module to Tech Products'!A1"><Data
        ss:Type="String">App Modules to Tech Products</Data></Cell>
      <Cell ss:StyleID="s1073"><Data ss:Type="String">Used to map Application Modules to the Technology used</Data></Cell>
     </Row>
    <Row ss:AutoFitHeight="0" ss:Height="20"> 
      <Cell  ss:Index="2" ss:StyleID="s1128" ss:HRef="#'App Interface to Tech Products'!A1"><Data
        ss:Type="String">App Interfaces to Tech Products</Data></Cell>
      <Cell ss:StyleID="s1073"><Data ss:Type="String">Used to map Application Interfaces to the Technology used</Data></Cell>
   </Row>
   ...
   <Row ss:Height="20">
    ...
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Defines the standard logical architectures to be used to implement IT solutions</Data></Cell>
   </Row>
   <Row ss:Height="20">
   ...
   <Row ss:Height="20">
    ...
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures the non-functional service qualities (e.g. scalability) associated with Technology Reference Architectures</Data></Cell>
   </Row>
   <Row ss:Height="20">
    ...
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures the values for the non-functional service qualities (e.g. scalability) and their relative score (1 - 10)</Data></Cell>
   </Row>
   <Row ss:Height="20">
    <Cell ss:Index="2" ss:StyleID="s1120" ss:HRef="#'Application Codebases'!A1"><Data
      ss:Type="String">Application Codebases</Data></Cell>
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures the types of Application Codebase relevant to the enterprise and their relative score (1 - 10)</Data></Cell>
   </Row>
   <Row ss:Height="20">
    ...
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures the different ways in which Applications are delivered and their relative score (1 - 10)</Data></Cell>
   </Row>
   <Row ss:Height="20">
    ...
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures the different ways in which Technology infrastructure services are delivered and their relative score (1 - 10)</Data></Cell>
   </Row>
   <Row ss:Height="20">
   ...
   <Row ss:Height="20">
    ...
    <Cell ss:StyleID="s1073"><Data ss:Type="String">Captures the different levels of compliance defined against Technology Product Standards and their relative score (1 - 10)</Data></Cell>
   </Row>
   <Row ss:Height="20">
 ...
 <Worksheet ss:Name="Application Capabilities">
  <Table ss:ExpandedColumnCount="12" x:FullColumns="1"
   ...
   <Row>
    <Cell ss:Index="2"><Data ss:Type="String">Captures the Application Capabilities required to support the business and the category to manage the structure of the view</Data></Cell>
 ...
 <Worksheet ss:Name="Application Modules">
  <Table ss:ExpandedColumnCount="9" x:FullColumns="1"
   ...
   <Row ss:Index="2" ss:Height="29">
    <Cell ss:Index="2" ss:MergeAcross="2" ss:StyleID="s1111"><Data ss:Type="String">Application Modules</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="19">
    <Cell ss:Index="2" ss:MergeAcross="7" ><Data ss:Type="String">Captures information about the Applications Modules (Application Providers) that are conatined within an Application (Composite Application Provider)</Data></Cell>
   </Row>
   <Row ss:Index="6" ss:Height="20">
    <Cell ss:Index="2" ss:StyleID="s1225"><Data ss:Type="String">ID</Data><Comment
      ss:Author="AutoGen"><ss:Data xmlns="http://www.w3.org/TR/REC-html40">                                            <Font
        html:Size="9" html:Color="#000000">A unique ID for the Application</Font>                                         </ss:Data></Comment></Cell>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Name</Data><Comment
      ss:Author="AutoGen"><ss:Data xmlns="http://www.w3.org/TR/REC-html40">                      <Font
        html:Size="9" html:Color="#000000">The name of the Application</Font>                   </ss:Data></Comment></Cell>
    <Cell ss:StyleID="s1225" ><Data ss:Type="String">Description</Data><Comment
      ss:Author="AutoGen"><ss:Data xmlns="http://www.w3.org/TR/REC-html40"><Font
        html:Color="#000000">                      </Font><Font html:Size="9"
        html:Color="#000000">A description of the functionality provided by the Application</Font><Font
        html:Color="#000000">                   </Font></ss:Data></Comment></Cell>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Parent Application</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="4">
    <Cell ss:Index="5" />
   </Row>
   <xsl:apply-templates select="$applicationModules" mode="applicationModules"/>
  </Table>
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   <PageSetup>
    <Header x:Margin="0.3"/>
  ...
  <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
   <Range>R243C5:R2000C5</Range>
   <Type>List</Type>
   <Value>App_Type</Value>
  </DataValidation>
  <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
   <Range>R8C5:R242C5</Range>
   <Type>List</Type>
 ...
 <Worksheet ss:Name="App Pro Interface">
  <Table ss:ExpandedColumnCount="11" x:FullColumns="1"
   ...
   <Column ss:AutoFitWidth="0" ss:Width="200"/>
   <Row ss:Index="2" ss:Height="29">
    <Cell ss:Index="2" ss:MergeAcross="2" ss:StyleID="s1111"><Data ss:Type="String">Application Provider Interface</Data></Cell>
   </Row>
   <Row ss:Height="19">
   ...
   <Row ss:Index="6" ss:Height="20">
    ...
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Description</Data><Comment
      ss:Author="AutoGen"><ss:Data xmlns="http://www.w3.org/TR/REC-html40">                      <Font
        html:Size="9" html:Color="#000000">A description of the functionality provided by the Application</Font>                   </ss:Data></Comment></Cell>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Interface CI #</Data></Cell>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Technology Used</Data></Cell>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Containing Application</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="8"/>
    <xsl:apply-templates select="$applicationAPIs" mode="applicationAPIs"/>  
  </Table>
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   <PageSetup>
    <Header x:Margin="0.3"/>
 ...
 <Worksheet ss:Name="App Interface Dependencies">
  <Table ss:ExpandedColumnCount="11"  x:FullColumns="1"
   x:FullRows="1" ss:DefaultColumnWidth="66" ss:DefaultRowHeight="16">
   <Column ss:AutoFitWidth="0" ss:Width="21"/>
   <Column ss:AutoFitWidth="0" ss:Width="190"/>
   ...
   <Column ss:Index="9" ss:AutoFitWidth="0" ss:Width="159"/>
   <Column ss:AutoFitWidth="0" ss:Width="104"/>
   <Column ss:AutoFitWidth="0" ss:Width="93"/>
   <Row ss:AutoFitHeight="0">
    <Cell/>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="29">
    <Cell/>
    <Cell ss:StyleID="s1111"><Data ss:Type="String">Application Interface Dependencies</Data></Cell>
    <Cell/>
    <Cell/>
   </Row>
   <Row ss:AutoFitHeight="0">
    <Cell/>
    <Cell ><Data ss:Type="String">Captures the information dependencies between applications using an app interface; where information passes between applications, the method for passing the information and the interface used</Data></Cell>
    <Cell/>
    <Cell/>
   </Row>
   <Row ss:AutoFitHeight="0">
   ...
   <Row ss:AutoFitHeight="0" ss:Height="20">
    <Cell/>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Source Application</Data></Cell>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Target Application</Data></Cell>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Information Exchanged</Data></Cell>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Acquisition Method</Data></Cell>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Frequency</Data></Cell>
    <Cell ss:StyleID="s1225"><Data ss:Type="String">Interface App Used</Data></Cell> 
    <Cell><Data ss:Type="String"> </Data></Cell>
    <Cell><Data ss:Type="String"></Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="8">
...
<Worksheet ss:Name="Physical Proc 2 App">
 ...
 <Worksheet ss:Name="Application Module 2 Server">
  <Table ss:ExpandedColumnCount="6"   x:FullColumns="1"
   x:FullRows="1" ss:DefaultColumnWidth="66" ss:DefaultRowHeight="16">
   <Column ss:Index="2" ss:AutoFitWidth="0" ss:Width="217"/>
   <Column ss:AutoFitWidth="0" ss:Width="236"/>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="29">
    <Cell ss:Index="2" ss:MergeAcross="2" ss:StyleID="s1111"><Data ss:Type="String">Application Module to Server</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0">
    <Cell ss:Index="2" ss:MergeAcross="2"><Data ss:Type="String">Mapps the application modules to the servers that they are hosted on, with the environment</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0">
    <Cell ss:Index="3" />
   </Row>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="20">
    <Cell ss:Index="2" ><Data ss:Type="String">App</Data></Cell>
    <Cell ><Data ss:Type="String">Server</Data></Cell>
    <Cell ><Data ss:Type="String">Environment</Data></Cell>
    <Cell ><Data ss:Type="String">Application Checker</Data></Cell>
    <Cell ><Data ss:Type="String">Server Checker</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="7">
    ...
    <Cell><Data ss:Type="String">.</Data></Cell>
       ...
       <xsl:apply-templates select="$technodes" mode="app2ServModule"></xsl:apply-templates> 
  </Table>
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   <PageSetup>
    <Header x:Margin="0.3"/>
   ...
   <Panes>
    <Pane>
     ...
     <RangeSelection>R10:R204</RangeSelection>
    </Pane>
   </Panes>
   <ProtectObjects>False</ProtectObjects>
   <ProtectScenarios>False</ProtectScenarios>
  ...
  <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
   <Range>R8C4:R9C4</Range>
   <Type>List</Type>
   <Value>Valid_Environments</Value>
  </DataValidation>
  <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
   <Range>R8C2:R9C2</Range>
   <Type>List</Type>
   <Value>Valid_App_Module</Value>
  </DataValidation>
  <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
   <Range>R8C3:R9C3</Range>
   <Type>List</Type>
   <Value>Servers!R8C3:R5000C3</Value>
  </DataValidation>
  <ConditionalFormatting xmlns="urn:schemas-microsoft-com:office:excel">
 ...
 <Worksheet ss:Name="App Interface to Server">
  <Table ss:ExpandedColumnCount="6" x:FullColumns="1"
   x:FullRows="1" ss:DefaultColumnWidth="66" ss:DefaultRowHeight="16">
   <Column ss:Index="2" ss:AutoFitWidth="0" ss:Width="217"/>
   <Column ss:AutoFitWidth="0" ss:Width="236"/>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="29">
    <Cell ss:Index="2" ss:MergeAcross="2" ss:StyleID="s1111"><Data ss:Type="String">Application Interface to Server</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0">
    <Cell ss:Index="2" ss:MergeAcross="2"><Data ss:Type="String">Maps the application interfaces to the servers that they are hosted on, with the environment</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0">
    <Cell ss:Index="3" />
   </Row>
   ...
   <xsl:apply-templates select="$technodes" mode="app2ServAPI"></xsl:apply-templates> 
  </Table>
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   <PageSetup>
    <Header x:Margin="0.3"/>
   ...
   <Panes>
    <Pane>
     <Number>3</Number>
     <ActiveRow>9</ActiveRow>
     <RangeSelection>R10:R172</RangeSelection>
    </Pane>
   </Panes>
   <ProtectObjects>False</ProtectObjects>
   <ProtectScenarios>False</ProtectScenarios>
 ...
 <Worksheet ss:Name="App Module to Tech Products">
    <Table ss:ExpandedColumnCount="13"  x:FullColumns="1"
     x:FullRows="1" ss:DefaultColumnWidth="66" ss:DefaultRowHeight="16">
     <Column ss:Index="2" ss:AutoFitWidth="0" ss:Width="179"/>
     <Column ss:AutoFitWidth="0" ss:Width="146"/>
     ...
     <Row ss:AutoFitHeight="0" ss:Height="29">
      <Cell/>
      <Cell ss:MergeAcross="2" ss:StyleID="s1111"><Data ss:Type="String">Application Technology Architecture</Data></Cell>
     </Row>
     <Row ss:AutoFitHeight="0">
      <Cell/>
      <Cell><Data ss:Type="String">Defines the technology architecture supporting applications in terms of Technology Products, the components that they implement and the dependencies between them</Data></Cell>
      <Cell/>
      <Cell/>
     </Row>
     <Row ss:AutoFitHeight="0">
     ...
     <Row ss:AutoFitHeight="0" ss:Height="20">
      ...
      <Cell><Data ss:Type="String">Environment</Data></Cell>
      <Cell><Data ss:Type="String">From Technology Product</Data></Cell>
      <Cell><Data ss:Type="String">From Technology Component</Data></Cell>
      <Cell><Data ss:Type="String">To Technology Product</Data></Cell>
      <Cell><Data ss:Type="String">To Technology Component</Data></Cell>
     ...
     <Row ss:AutoFitHeight="0" ss:Height="17">
      ...
      <Cell/>
      <Cell
       ss:Formula="=IF(RC[-6]&lt;&gt;&quot;&quot;,(IF(ISNA(VLOOKUP(RC[-6],'https://easglobal-my.sharepoint.com/Users/sarahsmith/Downloads/essential_launchpad_v5 (27)/[Essential_Launchpad_V55_Capture_Spreadsheet.xlsx]Applications'!C[-5],1,0)),&quot;Application must be already defined in Applications sheet&quot;,&quot;OK&quot;)),&quot;&quot;)"><Data
        ss:Type="String"></Data></Cell>
      <Cell
       ss:Formula="=IF(RC[-2]&lt;&gt;&quot;&quot;,IF(COUNTIF(Valid_Environments,RC[-6]),&quot;OK&quot;,&quot;Type MUST match the values in Launchpad.  To change these speak to us&quot;),&quot;&quot;)"><Data
        ss:Type="String"></Data></Cell>
      <Cell
       ss:Formula="=IF(RC[-6]&lt;&gt;&quot;&quot;,(IF(ISNA(VLOOKUP(RC[-6],'https://easglobal-my.sharepoint.com/Users/sarahsmith/Downloads/essential_launchpad_v5 (27)/[Essential_Launchpad_V55_Capture_Spreadsheet.xlsx]Technology Products'!C[-7],1,0)),&quot;Technology Product must be already defined in Technology Products sheet&quot;,&quot;OK&quot;)),&quot;&quot;)"><Data
        ss:Type="String"></Data></Cell>
      <Cell
       ss:Formula="=IF(RC[-6]&lt;&gt;&quot;&quot;,(IF(ISNA(VLOOKUP(RC[-6],'https://easglobal-my.sharepoint.com/Users/sarahsmith/Downloads/essential_launchpad_v5 (27)/[Essential_Launchpad_V55_Capture_Spreadsheet.xlsx]Technology Components'!C[-8],1,0)),&quot;Technology Component must be already defined in Technology Components sheet&quot;,&quot;OK&quot;)),&quot;&quot;)"><Data
        ss:Type="String"></Data></Cell>
      <Cell
       ss:Formula="=IF(RC[-6]&lt;&gt;&quot;&quot;,(IF(ISNA(VLOOKUP(RC[-6],'https://easglobal-my.sharepoint.com/Users/sarahsmith/Downloads/essential_launchpad_v5 (27)/[Essential_Launchpad_V55_Capture_Spreadsheet.xlsx]Technology Products'!C[-9],1,0)),&quot;Technology Product must be already defined in Technology Products sheet&quot;,&quot;OK&quot;)),&quot;&quot;)"><Data
        ss:Type="String"></Data></Cell>
      <Cell
       ss:Formula="=IF(RC[-6]&lt;&gt;&quot;&quot;,(IF(ISNA(VLOOKUP(RC[-6],'https://easglobal-my.sharepoint.com/Users/sarahsmith/Downloads/essential_launchpad_v5 (27)/[Essential_Launchpad_V55_Capture_Spreadsheet.xlsx]Technology Components'!C[-10],1,0)),&quot;Technology Component must be already defined in Technology Components sheet&quot;,&quot;OK&quot;)),&quot;&quot;)"><Data
        ss:Type="String"></Data></Cell>
     </Row>
    </Table>
    <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
    ...
    <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
     <Range>R8C4,R8C6</Range>
     <Type>List</Type>
     <UseBlank/>
     <Value>INDIRECT(&quot;TechProds[Name]&quot;)</Value>
    </DataValidation>
    <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
     <Range>R8C5,R8C7</Range>
     <Type>List</Type>
     <UseBlank/>
     <Value>INDIRECT(&quot;TechComp[Name]&quot;)</Value>
    </DataValidation>
    <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
     <Range>R8C3</Range>
     <Type>List</Type>
   ...
   <Worksheet ss:Name="App Interface to Tech Products">
    <Table ss:ExpandedColumnCount="13"  x:FullColumns="1"
     x:FullRows="1" ss:DefaultColumnWidth="66" ss:DefaultRowHeight="16">
     <Column ss:Index="2" ss:AutoFitWidth="0" ss:Width="179"/>
     <Column ss:AutoFitWidth="0" ss:Width="146"/>
    ...
    <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
     ...
     <Panes>
      <Pane>
       <Number>3</Number>
       <ActiveRow>9</ActiveRow>
       <RangeSelection>R10:R341</RangeSelection>
      </Pane>
     </Panes>
     <ProtectObjects>False</ProtectObjects>
     <ProtectScenarios>False</ProtectScenarios>
    ...
    <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
     <Range>R8C4:R9C4,R8C6:R9C6</Range>
     <Type>List</Type>
     <UseBlank/>
     <Value>INDIRECT(&quot;TechProds[Name]&quot;)</Value>
    </DataValidation>
    <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
     <Range>R8C5:R9C5,R8C7:R9C7</Range>
     <Type>List</Type>
     <UseBlank/>
     <Value>INDIRECT(&quot;TechComp[Name]&quot;)</Value>
    </DataValidation>
...
<xsl:template match="node()" mode="servers"> 
    ...
    <Cell ss:StyleID="s1076"/>
      ...
      <xsl:template match="node()" mode="app2ServAPI"> 
    ...
    <xsl:variable name="thisapps" select="$applicationAPIs[own_slot_value[slot_reference='deployments_of_application_provider']/value=$thisappsdeployment/name]"/> 
    
    <xsl:apply-templates select="$thisapps" mode="app2ServRow">
      <xsl:with-param name="srv" select="current()"/>
    </xsl:apply-templates>
  </xsl:template>
    <xsl:template match="node()" mode="app2ServModule"> 
    <xsl:variable name="thisappswinstance" select="$appswinstance[own_slot_value[slot_reference='technology_instance_deployed_on_node']/value=current()/name]"/> 
    <xsl:variable name="thisappsdeployment" select="$appsdeployment[own_slot_value[slot_reference='application_deployment_technology_instance']/value=$thisappswinstance/name]"/> 
    <xsl:variable name="thisapps" select="$applicationModules[own_slot_value[slot_reference='deployments_of_application_provider']/value=$thisappsdeployment/name]"/> 
...
<xsl:template match="node()" mode="applicationModules">
<xsl:variable name="parent" select="$allapplications[name=current()/own_slot_value[slot_reference='parent_application_provider']/value]"/>
 <Row ss:Height="17">
    <Cell ss:Index="2" ><Data ss:Type="String"><xsl:value-of select="current()/name"/></Data></Cell>
    <Cell><Data ss:Type="String"><xsl:call-template name="RenderMultiLangInstanceName"><xsl:with-param name="theSubjectInstance" select="current()"/><xsl:with-param name="isRenderAsJSString" select="false()"/></xsl:call-template></Data><NamedCell
      ss:Name="Valid_App_Module"/></Cell>
   <Cell><Data ss:Type="String"><xsl:call-template name="RenderMultiLangInstanceDescription"><xsl:with-param name="theSubjectInstance" select="current()"/><xsl:with-param name="isRenderAsJSString" select="false()"/></xsl:call-template></Data><NamedCell
      ss:Name="Valid_App_Module"/></Cell>
    <Cell><Data ss:Type="String"><xsl:call-template name="RenderMultiLangInstanceName"><xsl:with-param name="theSubjectInstance" select="$parent"/><xsl:with-param name="isRenderAsJSString" select="false()"/></xsl:call-template></Data><NamedCell
      ss:Name="Valid_App_Module"/></Cell>
   </Row>
</xsl:template>
<xsl:template match="node()" mode="applicationAPIs">
<xsl:variable name="parent" select="$allapplications[name=current()/own_slot_value[slot_reference='parent_application_provider']/value]"/>
<Row ss:Height="17">Valid_API
    <Cell ss:Index="2" ><Data ss:Type="String"><xsl:value-of select="current()/name"/></Data></Cell>
    <Cell><Data ss:Type="String"><xsl:call-template name="RenderMultiLangInstanceName"><xsl:with-param name="theSubjectInstance" select="current()"/><xsl:with-param name="isRenderAsJSString" select="false()"/></xsl:call-template></Data><NamedCell
      ss:Name="Valid_API"/></Cell>
    <Cell/>
    <Cell/>
    <Cell/>
    <Cell><Data ss:Type="String"><xsl:call-template name="RenderMultiLangInstanceName"><xsl:with-param name="theSubjectInstance" select="$parent"/><xsl:with-param name="isRenderAsJSString" select="false()"/></xsl:call-template></Data><NamedCell
