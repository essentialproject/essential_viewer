...
joint.shapes.uml. Class = joint.shapes.basic.Generic.extend(
{
    ...
    defaults: joint.util.deepSupplement(
    {
        ...
        attrs:
        {
            ...
            '.uml-class-name-rect':
            {
                'stroke': 'white', 'stroke-width': 2, 'fill': '#3498db'
            },
            '.uml-class-attrs-rect':
            {
                'stroke': 'white', 'stroke-width': 2, 'fill': '#2980b9'
            },
    ...
    dataObjects: joint.util.deepSupplement(
    {
        type: 'uml.DataObject',
        attrs:
        {
            ...
            '.uml-class-name-rect':
            {
                'stroke': '#333333', 'stroke-width': 2, 'fill': '#333333'
            },
            '.uml-class-attrs-rect':
            {
                'stroke': '#333333', 'stroke-width': 2, 'fill': '#333333'
            ...
            {
                'ref': '.uml-class-name-rect', 'ref-y': .5, 'ref-x': .5, 'text-anchor': 'middle', 'y-alignment': 'middle', 'font-weight': 'bold',
                'fill': '#333333', 'font-size': 16, 'font-family': 'Arial'
            },
            '.uml-class-attrs-text':
            {
                'ref': '.uml-class-attrs-rect', 'ref-y': 5, 'ref-x': 5,
                'fill': '#333333', 'font-size': 12, 'font-family': 'Arial'
            },
            '.uml-class-methods-text':
            {
                'ref': '.uml-class-methods-rect', 'ref-y': 5, 'ref-x': 5,
    ...
    joint.shapes.basic.Generic.prototype.dataObjects),
    otherDataObjects: joint.util.deepSupplement(
    {
        type: 'uml.OtherDataObject',
        attrs:
        {
            rect:
            {
            ...
            '.uml-class-name-rect':
            {
                'stroke': '#aaaaaa', 'stroke-width': 2, 'fill': '#aaaaaa'
            },
            '.uml-class-attrs-rect':
            {
                'stroke': '#aaaaaa', 'stroke-width': 2, 'fill': '#aaaaaa'
    ...
    joint.shapes.basic.Generic.prototype.otherDataObjects),
    initialize: function ()
    {
...
joint.shapes.uml.DataObject = joint.shapes.uml. Class.extend(
{
    defaults: joint.util.deepSupplement(
    {
        type: 'uml.DataObject',
    ...
    joint.shapes.uml. Class.prototype.dataObjects),
    getClassName: function ()
    {
        return[ this.get('name')];
    }
});
joint.shapes.uml.DataObjectView = joint.shapes.uml.ClassView;
joint.shapes.uml.OtherDataObject = joint.shapes.uml. Class.extend(
{
    defaults: joint.util.deepSupplement(
    {
        type: 'uml.OtherDataObject',
    ...
    joint.shapes.uml. Class.prototype.otherDataObjects),
    getClassName: function ()
    {
        return[ this.get('name')];
    }
...
joint.shapes.uml.Aggregation = joint.dia.Link.extend(
{
    defaults:
    {
        ...
        attrs:
        {
            '.marker-target':
            {
                d: 'M 40 10 L 20 20 L 0 10 L 20 0 z', fill: 'white'
            },
            '.marker-vertices':
            {
                display: 'none'
...
joint.shapes.uml.Composition = joint.dia.Link.extend(
{
    defaults:
    {
        ...
        attrs:
        {
            '.marker-target':
            {
                d: 'M 40 10 L 20 20 L 0 10 L 20 0 z', fill: 'black'
            },
            '.marker-vertices':
            {
                display: 'none'
...
joint.shapes.uml.StartState = joint.shapes.basic.Circle.extend(
{
    defaults: joint.util.deepSupplement(
    {
        ...
        attrs:
        {
            circle:
            {
                'fill': '#34495e', 'stroke': '#2c3e50', 'stroke-width': 2, 'rx': 1
            }
        }
    },
...
joint.shapes.uml.Transition = joint.dia.Link.extend(
{
    defaults:
    {
        ...
        attrs:
        {
            '.marker-target':
            {
                d: 'M 10 0 L 0 5 L 10 10 z', fill: '#34495e', stroke: '#2c3e50'
            },
            '.connection':
            {
                stroke: '#2c3e50'
