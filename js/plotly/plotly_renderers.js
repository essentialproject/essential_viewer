  ...
  callWithJQuery(function($, Plotly) {
    ...
    makePlotlyChart = function(traceOptions, layoutOptions, transpose) {
      ...
      return function(pivotData, opts) {
        ...
        //PBB don't specify size of chart, our parent will do that when we resize
        layout = {
          title: titleText,
          hovermode: 'closest' // ,
        ...
        //PBB we have to specify width and height so that we can resize the charts
        //when the window or the grid resizes
        //result = $('<div style="width:50%;height:50%;"></div>').appendTo($("body"));
        result = $('<div style="width:78vw;height:100vh;"></div>').appendTo($("body"));
        //PBB we have to keep a reference to the div for this chart so we can resize it later
        //opts.plotlyConfig.responsive=true;
        PLOTLYDIVS.push(result[0]);  
