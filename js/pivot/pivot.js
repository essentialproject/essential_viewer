(function() {
  ...
  callWithJQuery(function($) {
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      var a, aggregator, attr, attrLength, attrValues, c, colOrderArrow, defaults, e, existingOpts, fn1, i, initialRender, l, len1, len2, len3, localeDefaults, localeStrings, materializedInput, n, o, opts, ordering, pivotTable, recordsProcessed, ref, ref1, ref2, ref3, refresh, refreshDelayed, renderer, rendererControl, rowOrderArrow, shownAttributes, shownInAggregators, shownInDragDrop, tr0, tr1, tr2, uiTable, unused, unusedAttrsVerticalAutoCutoff, unusedAttrsVerticalAutoOverride, x;
      if (overwrite == null) {
        overwrite = false;
      }
      if (locale == null) {
      ...
      try {
        ...
        unused = $("<td width='600px'>").addClass('pvtAxisContainer pvtUnused pvtUiCell  pvtHorizList');
        ...
        fn1 = function(attr) {
          ...
          var attrText=attr;
          if(opts.attrsDictionary[attr]){
            attrText=opts.attrsDictionary[attr];
          }
          valueList.append($("<h4>").append($("<span>").text(attrText), $("<span>").addClass("count").text("(" + values.length + ")")));
          ...
          attrElem = $("<li>").addClass("axis_" + i).append($("<span>").addClass('pvtAttr').append(attrText).data("attrName", attr).append(triangleLink));
          if (hasExcludedItem) {
            attrElem.addClass('pvtFilteredAttribute');
          }
        ...
        tr0 = $("<tr>").appendTo(uiTable).append(unused);
