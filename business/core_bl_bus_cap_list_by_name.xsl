...
<xsl:stylesheet version="2.0" xpath-default-namespace="http://protege.stanford.edu/xml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xslt" xmlns:pro="http://protege.stanford.edu/xml" xmlns:eas="http://www.enterprise-architecture.org/essential" xmlns:functx="http://www.functx.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ess="http://www.enterprise-architecture.org/essential/errorview">
	...
	<!-- 27.06.2018	JWC i18N version of catalogue -->
		...
		<xsl:choose>
			<xsl:when test="string-length($viewScopeTermIds) > 0">
				...
				<xsl:variable name="pageLabel">
					<xsl:value-of select="eas:i18n('Business Capability Catalogue by Name')"/>
				</xsl:variable>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<p><xsl:value-of select="eas:i18n('Please click on one of the Business Capabilities below to navigate to the required view')"/>.</p>
							<div>
								<p class="AlphabetQuickJumpLabel hidden-xs"><xsl:value-of select="eas:i18n('Go to')"/>:</p>
								<div class="AlphabetQuickJumpLinks hidden-xs">
									
									<!-- Build a list of the names of the elements to be sorted -->
									<xsl:variable name="anInFocusInstances" select="$inScopeBusCaps"></xsl:variable>
								...
								<xsl:call-template name="Index">
									...
									<xsl:with-param name="inScopeInstances" select="$inScopeBusCaps"/>
								</xsl:call-template>
