	...
	<xsl:template match="knowledge_base">
		...
		<html>
			<head>
				...
				<title>
					<xsl:value-of select="eas:i18n('Business Process Family Catalogue')"/>
				</title>
				...
				<div class="container-fluid" id="main">
							...
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">
										<xsl:value-of select="eas:i18n('Business Process Family Catalogue as Table')"/>
									</span>
								</h1>								
							</div>
						</div>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<p><xsl:value-of select="eas:i18n('This table lists all the Business Process Families in use and allows search as well as copy to spreadsheet')"/>.</p>
