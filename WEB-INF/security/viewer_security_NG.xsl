...
<xsl:stylesheet 
    ...
    <xsl:param name="defaultClassificationClassXML"/>
    <xsl:param name="theClassSetXML"/>
	...
	<eas:apiRequests>
		
		{
			"apiRequestSet": [
                ...
                {
				"variable": "defaultClassificationClassXML",
				"query": "/classes?className=EA_Default_Classification"
				},
                {
				"variable": "theClassSetXML",
				"query": "/classes"
				}
			]
		}
    ...
    <xsl:variable name="defaultClassificationClass" select="$defaultClassificationClassXML//class"/>
    <xsl:variable name="theClassSet" select="$theClassSetXML//class"/>
