...
public class SecureMaintenanceService extends EssentialMaintenanceService 
{
	 ...
	 */
	private static final Logger itsLog = LoggerFactory.getLogger(SecureMaintenanceService.class);
	...
	protected void doGet(HttpServletRequest theRequest, HttpServletResponse theResponse) throws ServletException, IOException 
	{
		// Authenticate the user
 		...
 		String anAccount = aSecurityMgr.authenticateUserBySession(theRequest, theResponse);
 		if(anAccount == null)
 		{
												  ...
												  HttpServletResponse theResponse)
	{
		...
		{			
			...
			try
			{
				...
				{
					// report the error to the log - if we can't produce the Error View
					itsLog.error("FATAL Error: {}", anEx);					
