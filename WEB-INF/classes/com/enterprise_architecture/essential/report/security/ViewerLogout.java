...
public class ViewerLogout extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest theRequest, HttpServletResponse theResponse) throws ServletException, IOException 
	{
    	...
    	// TRACE
    	//System.out.println("Doing logout from context: " + aContextPath);
    	
    	ViewerSecurityManager aSecurityManager = new ViewerSecurityManager(getServletContext());
    	aSecurityManager.removeUserSession(theRequest, theResponse);
