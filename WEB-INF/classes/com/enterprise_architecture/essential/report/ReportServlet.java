/** Copyright (c)2008-2015 Enterprise Architecture Solutions ltd. and the Essential Project
 * contributors.
 ...
 */
 public class ReportServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet
 {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		aContentType = request.getParameter("CT");
		aFilename = request.getParameter("FILE");
