/**
 * Copyright (c)2011-2019 Enterprise Architecture Solutions ltd. and the Essential Project
 * contributors.
...
public class ViewerCacheManager 
{
	 ...
	 */
	private static final Logger itsLog = LoggerFactory.getLogger(ViewerCacheManager.class);	
	...
	public ViewerCacheManager(InputStream theCacheConfiguration) 
	{
		...
		{
			itsLog.error("ViewerCacheManager Error processing configuration XML file: {}", aJaxbEx);			
		}		
		catch (IllegalArgumentException anIllegalArgEx)
		{
			itsLog.error("ViewerCacheManager Error unmarshalling configuration XML file: {}", anIllegalArgEx);			
		}
	}
