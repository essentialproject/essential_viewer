...
<!-- Essential Publishing 403 Error Page -->
		...
		<div class="container-fluid ">
			<div class="verticalSpacer_10px"></div>
			 <div class="row">
			 	<div class="col-xs-12">
                    <h2>Error</h2>
                    <p>Your username and password appear correct however this content is restricted and you do not have permission to access this page</p>
                    <p><a href='protected/logout.jsp'>Click here to try again as a different user</a>.</p>
			 	</div>
			 </div>	
		</div>
		<footer>
