			 ...
			 <div class="row">
			 	<div class="col-xs-12">
					...
					<form method="post" action="j_security_check" class="form-signin">
						<input id="inputUsername" type="text" class="form-control" name="j_username" placeholder="Username" required/>
						<label for="inputUsername" class="sr-only">Username</label></td>
