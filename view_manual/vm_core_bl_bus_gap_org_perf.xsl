	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Business Change Analysis - Organisation Performance Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Business Change Analysis - Organisation Performance Gap</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Business Architecture models and the Target Business Architecture models. This view focuses on Organisation Performance Gaps - a change in drivers, objectives or measures. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/bus_gap_org_perf_MM.png" alt="Business Change Analysis - Organisation Performance Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<table class="table table-bordered table-striped ">
									<thead>
										<tr>
											<th class="cellWidth-15pc">Navigation</th>
											<th class="cellWidth-20pc">Essential Class</th>
											<th class="cellWidth-20pc">Additional Slots</th>
											<th class="cellWidth-20pc">Notes</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td rowspan="2">Business/Conceptual</td>
											<td rowspan="2">Business Driver</td>
											<td class="textColourRed">Motivated by Objectives</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td class="textColourRed">Classified as</td>
											<td>Select the correct Driver Classification, i.e. Gap</td>
										</tr>
										<tr>
											<td rowspan="4">Business/Conceptual</td>
											<td rowspan="4">Business Objective</td>
											<td>Supported by Objectives</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td>Supported by Strategic Plans</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td class="textColourRed">Motivated by Drivers</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td class="textColourRed">Classified as</td>
											<td>Select the correct Objective Classification, i.e. Company</td>
										</tr>
										<tr>
											<td rowspan="6">EA Support/ Strategy Management</td>
											<td rowspan="6">Business Strategic Plan</td>
											<td class="textColourRed">Strategic Plan for Elements </td>
											<td>Populate with Business Drivers and Business Objectives</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>Required if replacing one element with another i.e. the plan to remove an Objective is dependent on the creation of another.</td>
										</tr>
										<tr>
											<td class="textColourRed">Supports Objectives</td>
											<td>&#160;</td>
										</tr>
										<tr>
										...
										<tr>
											<td class="textColourRed">Business Conceptual Elements</td>
											<td>Populated with Business Drivers</td>
										</tr>
										<tr>
											<td>Information/ Conceptual</td>
											<td>Information Architecture Objective</td>
											<td>&#160;</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td>Application/ Conceptual</td>
											<td>Application Architecture Objective</td>
											<td>&#160;</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td>Technology/ Conceptual</td>
											<td>Technology Architecture Objective</td>
											<td>&#160;</td>
											<td>&#160;</td>
										</tr>
									</tbody>
								...
								<h4>Note 2</h4> These items should be re-used , ie created only once for all Business Gap Reports. The Business Roadmap should be created first and the Report Constant set up as detailed in the Business Roadmap View Manual. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/bus_gap_org_perf_SS.png" alt="Business Change Analysis - Organisation Performance Gap" class="screenshotFrame"/>
							</div>
						</div>
