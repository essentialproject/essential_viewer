	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Information Change Analysis - Data Scarcity / Redundancy Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Information Change Analysis - Data Scarcity / Redundancy Gap</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Data Architecture models and the Target Data Architecture models. This view focuses on Data Scarcity / Redundancy Gaps. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/inf_gap_data_scar_red_MM.png" alt="Information Change Analysis - Data Scarcity / Redundancy Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/inf_gap_data_scar_red_SS.png" alt="Information Change Analysis - Data Scarcity / Redundancy Gap" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
