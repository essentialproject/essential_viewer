	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Business Change Analysis - Location Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Business Change Analysis - Location Gap</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Business Architecture models and the Target Business Architecture models. This view focuses on Location Gaps - change in the geographic locations of service outlets, offices, fixed assets, installations, facilities and the climate or geological environment in which these assets are inhabited. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/bus_gap_location_MM.png" alt="Business Change Analysis - Location Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										...
										<tr>
											...
											<td>Instance of Site Category</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td>Contained Sites</td>
											<td>&#160;</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td rowspan="2">Actor (Individual OR Group)</td>
											<td class="textColourRed">Roles Played by Actor</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td>Primary Base Site</td>
											<td>&#160;</td>
										</tr>
										<tr>
											...
											<td>Populate with Sites and associated Physical Processes and Actors</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>Populated with Sites, Physical Processes and Actors</td>
										</tr>
										<tr>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/bus_gap_location_SS.png" alt="Business Change Analysis - Location Gap" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
