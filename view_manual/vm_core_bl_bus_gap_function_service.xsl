	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Business Change Analysis - Function / Service Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Business Change Analysis - Function / Service Gap</span>
								</h1>
							</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Business Architecture models and the Target Business Architecture models. This view focuses on Function / Service Gaps - change to the portfolio of services/functions that a department performs. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/bus_gap_func_serv_MM.png" alt="Business Change Analysis - Function / Service Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										...
										<tr>
											...
											<td>Strategic Plan for Elements </td>
											<td>Populate with Product Types</td>
										</tr>
										<tr>
											<td>Strategic Planning Action</td>
											<td>&#160;</td>
										</tr>
										<tr>
										...
										<tr>
											<td>Depends On Strategic Plans</td>
										...
										<tr>
											...
											<td>State Valid From Date</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td>State Valid To Date</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td>Business logical Elements</td>
											<td>Populated with Product Type</td>
										</tr>
										<tr>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/bus_gap_func_serv_SS.png" alt="Business Change Analysis - Function / Service Gap" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
