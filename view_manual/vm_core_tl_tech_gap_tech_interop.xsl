	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Technology Change Analysis - Technology Interoperability Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Technology Change Analysis - Technology Interoperability Gap</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">To inform stakeholders regarding the redundancies and deficiencies of technologies and interoperability standards in an enterprise. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Architecture models and the Target Architecture models. This view focuses on the Technology Interoperability Standards Gap. The technology distribution gap is informed by Technology Distribution Model. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/tech_gap_tech_interop_MM.png" alt="Technology Change Analysis - Technology Interoperability Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										<tr>
											<td>:System Class/ :Relation/ :Directed Binary Relation/ :EA Graph Relation/ :Technology Relationships/ :TCA RELATION</td>
											<td>:TCU-TO-TCU--RELATION</td>
											<td>&#160;</td>
											<td>This relation is the dependencies between the Technology Components in the Technology Component Architecture. See Note 1</td>
										</tr>
										<tr>
											<td rowspan="5">EA Support/ Strategy Management</td>
											<td rowspan="5">Technology Strategic Plan</td>
											<td class="textColourRed">Strategic Plan for Elements </td>
											<td>Populate with :TCU-TO-TCU-RELATION</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>Double click on lines between milestones and populate supporting strategic plans field with previously defined technology strategic plans</td>
										</tr>
										<tr>
										...
										<tr>
											<td>Milestone Architecture State</td>
											<td>&#160;</td>
										</tr>
										<tr>
											<td rowspan="3">EA Support/ Strategy Management</td>
										...
										<tr>
											<td class="textColourRed">Technology Logical Elements</td>
											<td>Populated with :TCU-TO-TCU-RELATION</td>
										</tr>
										<tr>
								...
								<h4>Note 1</h4>
								<p>This view is informed by the Technology Distribution Model, specifically the creation of the Technology Component Architecture. The relationships defined in that report must, therefore, also be completed. Please refer to the instructions in the Technology Distribution Model View Manual</p>
								<h4>Note 2</h4>
								...
								<ul>
									...
									<li>Now double click on the arrows between the milestones and populate the ‘Supporting Strategic Plans’ field with the previously defined Technology Strategic Plans.</li>
								</ul>
								<h4>Note 3</h4>
								<p>These items should be re-used, i.e. created only once for all Technology Gap Reports. The Technology Roadmap should be created first and the Report Constant set up as detailed in the Technology Roadmap View Manual.</p>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/tech_gap_tech_interop_SS.png" alt="Technology Change Analysis - Technology Interoperability Gap" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
