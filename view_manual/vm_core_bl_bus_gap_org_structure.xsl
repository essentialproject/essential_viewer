	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Business Change Analysis - Organisation Structure Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Business Change Analysis - Organisation Structure Gap</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Business Architecture models and the Target Business Architecture models. This view focuses on Organisation Structure Gaps - change to directorates and organisation units. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/bus_gap_org_str_MM.png" alt="Business Change Analysis - Organisation Structure Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										<tr>
											...
											<td rowspan="4">Group Business Role</td>
											<td>Is Business Role Type</td>
											<td rowspan="7"> Complete either one or both of Group and Individual Business Role</td>
										</tr>
										<tr>
											<td class="textColourGreen">Is Member of Business Role</td>
										</tr>
										<tr>
											<td class="textColourGreen">Contains Business Role</td>
										</tr>
										<tr>
											<td>Actors Playing this Role</td>
										</tr>
										<tr>
											<td rowspan="3">Business/Logical</td>
											<td rowspan="3">Individual Business Role</td>
											<td>Is Business Role Type </td>
										</tr>
										<tr>
											<td class="textColourGreen">Is Member of Business Role</td>
										...
										<tr>
											<td class="textColourGreen">Actors Playing this Role</td>
										</tr>
										<tr>
											<td rowspan="3">Business/Physical</td>
											<td rowspan="3">Group Actor</td>
											<td class="textColourGreen">Parent Organisation</td>
											<td rowspan="5"> Complete either one or both of Group and Individual Actor </td>
										</tr>
										<tr>
											<td class="textColourGreen">Contained Sub Actors</td>
										</tr>
										<tr>
											<td class="textColourRed">Roles Played by Actor</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>Populate with Actor and Business Role</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>Required if replacing one element with another i.e. the plan to remove a Role is dependent on the creation of another.</td>
										</tr>
										<tr>
										...
										<tr>
											<td rowspan="4">EA Support/ Strategy Management</td>
											<td rowspan="4">Architecture State (See Note 2) </td>
										...
										<tr>
											<td class="textColourRed">Business Logical Elements</td>
											<td>Populated with Business Role</td>
										</tr>
										<tr>
											<td class="textColourRed">Business Physical Elements</td>
											<td>Populated with Actor</td>
										</tr>
										<tr>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/bus_gap_org_str_SS.png" alt="Business Change Analysis - Organisation Structure Gap" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
