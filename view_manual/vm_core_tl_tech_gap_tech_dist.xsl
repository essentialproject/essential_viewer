	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Technology Change Analysis - Technology Distribution Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Technology Change Analysis - Technology Distribution Gap</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Architecture models and the Target Architecture models. This view focuses on the Technology Distribution Gap. The technology distribution gap is informed by Technology Distribution Model. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/tech_gap_tech_comp_MM.png" alt="Technology Change Analysis - Technology Distribution Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										<tr>
											...
											<td>Technology/Physical</td>
											<td>Technology Instance </td>
											<td>&#160;</td>
											<td>See Note 1</td>
										</tr>
										<tr>
											...
											<td>Populate with Technology Instance</td>
										</tr>
										<tr>
										...
										<tr>
											<td class="textColourRed">Technology Physical Elements</td>
											<td>Populated with Technology Instance</td>
										</tr>
										<tr>
								...
								<h4>Note 1</h4>
								<p>This view is informed by the Technology Distribution Model. The relationships defined in that report must, therefore, also be completed. Please refer to the instructions in the Technology Distribution Model View Manual </p>
								<h4>Note 2</h4>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/tech_gap_tech_comp_SS.png" alt="Technology Change Analysis - Technology Distribution Gap" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
