	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Technology Roadmap Model</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Technology Roadmap Model</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">To inform stakeholders regarding the major Technology initiatives (or project) to be undertaken by the enterprise to address the deficiencies and redundancies as identified during the prior gap analysis. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A Technology Architecture Roadmap which outlines a list of individual increments of change over a timeline to show progression from the Baseline Architecture to the Target Architecture. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div>
								...
								<br/>
								<img src="view_manual/vm_images/tech_roadmap_model_MM.png" alt="Technology Roadmap Model Meta-Model"/>
							</div>
							<hr/>
						</div>
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										<tr>
											...
											<td rowspan="5">Application/ Technology Strategic Plans</td>
											<td><span class="textColourRed">Strategic Plan for Elements </span>(See Note 1) </td>
											<td>Populate with Architecture elements as required:- •Technology Component •Technology Composite •Technology Component Architecture •Technology Component Usage •Technology Instance •:TCU-TO-TCU-RELATION •Application Provider </td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>Populated with elements from the list in the notes section of Strategic Plan class on slide 6. </td>
										</tr>
										<tr>
						...
						<div class="col-xs-12">
							...
							<div>
								<br/>
								<img src="view_manual/vm_images/tech_roadmap_model_SS.png" alt="Technology Roadmap Model" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
						<!--Setup Closing Tags-->
