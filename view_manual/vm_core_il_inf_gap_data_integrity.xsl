	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Information Change Analysis - Data Integrity Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Information Change Analysis - Data Integrity Gap</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">To inform stakeholders regarding the redundancies and deficiencies of data in an enterprise. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Data Architecture models and the Target Data Architecture models. This view focuses on Data Integrity Gaps, showing planned changes to Security Policies. This view is informed by the Data Security Model. This view is accessed via a Data Catalogue and shows the planned changes to the Security Policies for a selected Data Object. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/inf_gap_data_integrity_MM.png" alt="Information Change Analysis - Data Integrity Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										<tr>
											<td>EA Support/ Security Management/ Security Logical</td>
										...
										<tr>
											...
											<td rowspan="5">Security Management Strategic Plan</td>
											<td class="textColourRed">Strategic Plan for Elements </td>
											<td>Populate with Security Policy (See Note 1)</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>Double click on lines between milestones and populate supporting strategic plans field with previously defined information strategic plans</td>
										</tr>
										<tr>
										...
										<tr>
											<td class="textColourRed">Security Management Elements</td>
											<td>Populated with Security Policy (See Note 1)</td>
										</tr>
										<tr>
								...
								<h4>Note 1</h4>
								<p>This view is informed by the Data Security Model, therefore the relationships defined in that report must also be completed. Please refer to the instructions in the Data Security Model View Manual for details.</p>
								<h4>Note 2</h4>
								...
								<ul>
									...
									<li>Now double click on the arrows between the milestones and populate the ‘Supporting Strategic Plans’ field with the previously defined Information Strategic Plans.</li>
								</ul>
								<h4>Note 3</h4>
								<p>These items should be re-used , ie created only once for all Information Gap Reports. The Information Roadmap should be created first and the Report Constant set up as detailed in the Information Roadmap View Manual.</p>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/inf_gap_data_integrity_SS.png" alt="Information Change Analysis - Data Integrity Gap" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
