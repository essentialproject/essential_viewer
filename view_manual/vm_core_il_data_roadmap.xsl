	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Data Roadmap Model</title>
			</head>
			<body>
					...
					<div class="row">
						<div>
							<div class="col-xs-12">
								<div class="page-header">
									<h1>
										...
										<span class="text-darkgrey">Data Roadmap Model</span>
									</h1>
								</div>
							</div>
							...
							<div class="col-xs-12">
								...
								<div class="content-section">To inform stakeholders regarding the major Information and Data initiatives (or project) to be undertaken by the enterprise to address the deficiencies and redundancies as identified during the prior gap analysis. </div>
								<hr/>
							</div>
							...
							<div class="col-xs-12">
								...
								<div class="content-section">A Data Architecture Roadmap which outlines a list of individual increments of change over a timeline to show progression from the Baseline Architecture to the Target Architecture. </div>
								<hr/>
							</div>
							...
							<div class="col-xs-12">
								...
								<div class="content-section">
									...
									<br/>
									<img src="view_manual/vm_images/data_roadmap_model_MM.png" alt="Data Roadmap Model Meta-Model"/>
								</div>
								<hr/>
							</div>
									...
									<table class="table table-bordered table-striped ">
										...
										<tbody>
											<tr>
												...
												<td rowspan="5">Business/ Application/ Information Strategic Plans</td>
												...
												<td>Populate with Architecture elements as required:- <ul>
														<li>Data Objects</li>
														<li>Information Representations</li>
							...
							<div class="col-xs-12">
								...
								<div class="content-section">
									<br/>
									<img src="view_manual/vm_images/data_roadmap_model_SS.png" alt="Data Roadmap Model" class="screenshotFrame"/>
								</div>
								<hr/>
							</div>
