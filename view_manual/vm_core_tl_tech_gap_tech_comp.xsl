	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Technology Change Analysis - Technology Component Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Technology Change Analysis - Technology Component Gap</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Architecture models and the Target Architecture models. This report concentrates on the Technology Component Gaps. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/tech_gap_tech_comp_MM.png" alt="Technology Change Analysis - Technology Component Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
							...
							<div class="content-section">
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										...
										<tr>
											<td rowspan="5">Objective; Gap; Work Package</td>
											...
											<td>Populate with Technology Component</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>Populated with Technology Components</td>
										</tr>
										<tr>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/tech_gap_tech_comp_SS.png" alt="Technology Change Analysis - Technology Component Gap" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
