	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Application Change Analysis - Application Distribution Gap</title>
			</head>
			<body>
						...
						<div>
							<div class="col-xs-12">
								<div class="page-header">
									<h1>
										...
										<span class="text-darkgrey">Application Change Analysis - Application Distribution Gap</span>
									</h1>
								</div>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="sectionIcon">
										...
										<p>This view focuses on the Application Distribution Gap. The application distribution gap is informed by Application Distribution Model.</p>
									</div>
								</div>
							...
							<div class="col-xs-12">
								<div class="sectionIcon">
									...
									<br/>
									<img src="view_manual/vm_images/app_gap_app_dist_MM.png" alt="Application Change Analysis - Application Distribution Gap Meta-Model"/>
								</div>
							</div>
									...
									<table class="table table-bordered table-striped ">
										...
										<tbody>
											<tr>
												...
												<td class="textColourRed">Provides Application Service</td>
												<td rowspan="2">See Note 1</td>
											</tr>
											<tr>
												<td>Business/Physical</td>
												<td>Physical Business Process</td>
											...
											<tr>
												...
												<td>Physical Business Processes that make use of Application Providers</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>Populated with APP_PRO_PHYS_BUS_RELATION (in Relationship class)</td>
											</tr>
											<tr>
							...
							<div class="col-xs-12">
								<div class="sectionIcon">
									...
									<br/>
									<img src="view_manual/vm_images/app_gap_app_dist_SS.png" alt="Application Change Analysis - Application Distribution Gap" class="screenshotFrame"/>
								</div>
							</div>
