	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Business Change Analysis - Information System Gap</title>
			</head>
			<body>
						...
						<div>
							<div class="col-xs-12">
								<div class="page-header">
									<h1>
										...
										<span class="text-darkgrey">Business Change Analysis - Information System Gap</span>
									</h1>
								</div>
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Business Architecture models and the Target Business Architecture models. This view focuses on Information Systems Gaps - change to the Information System portfolio that is used to automate the service/functions of a department. </div>
								</div>
								...
								<div class="col-xs-12">
									<div class="sectionIcon">
										...
										<br/>
										<img src="view_manual/vm_images/bus_gap_info_sys_MM.png" alt="Business Change Analysis - Information System Gap Meta-Model"/>
									</div>
								</div>
										...
										<table class="table table-bordered table-striped ">
											...
											<tbody>
												<tr>
													...
													<td class="textColourRed">Supporting Applications</td>
													<td>&#160;</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td>Populate with Application Providers and associated Business Processes</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td>Populated with Application Providers</td>
												</tr>
												<tr>
													<td>&#160;</td>
													<td>&#160;</td>
							...
							<div class="col-xs-12">
								<div class="sectionIcon">
									...
									<br/>
									<img src="view_manual/vm_images/bus_gap_info_sys_SS.png" alt="Business Change Analysis - Information System Gap" class="screenshotFrame"/>
								</div>
							</div>
