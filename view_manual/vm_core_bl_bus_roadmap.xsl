	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Business Roadmap Model</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Business Roadmap Model</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">To inform stakeholders regarding the major Business initiatives (or project) to be undertaken by the enterprise to address the deficiencies and redundancies as identified during the prior gap analysis. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A Business Architecture Roadmap which outlines a list of individual increments of change over a timeline to show progression from the Baseline Architecture to the Target Architecture. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/bus_roadmap_model_MM.png" alt="Business Roadmap Model Meta-Model"/>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										<tr>
											...
											<td rowspan="5">Business / Information / Application Strategic Plans</td>
											<td><span class="textColourRed">Strategic Plan for Elements</span> (See Note 1)</td>
											<td>Populate with architecture elements as required:- <ul><li>Business Drivers </li><li>Business Objectives</li><li>Business Actor</li><li>Business Role</li><li>Site</li><li>Business Processes</li><li>Physical Processes</li><li>Product Type</li><li>Business Rule</li><li>Related Information Views</li><li>Related Application Providers</li></ul></td>
										</tr>
										<tr>
								...
								<br/>
								<h4>Note 1</h4>
								<p>This view is informed by the Business Gap Reports, therefore the relationships defined in those reports must also be completed. Please refer to the Business Change Analysis View Manuals for detailed instructions on how to capture these elements</p>
								<h4>Note 2</h4>
								...
								<h4>Note 3</h4>
								<p>These items should be re-used , i.e. created only once for all Business Gap Reports</p>

								<p>For this view, and all subsequent Gap Reports, to navigate the meta model successfully the Business Roadmap created needs to be defined in the Report. To complete the set-up follow these steps:-</p>
								<ul><li>Navigate to <em>EA Support/Essential Viewer/Report Constant</em> and select the <em>Business Roadmap</em> class.</li>
									<li>Click <strong>ADD</strong> in the <em>Associated Instances</em> slot and select the <em>Business Roadmap Model</em> that has been created</li>.</ul>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/bus_roadmap_model_SS.png" alt="Business Roadmap Model" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
