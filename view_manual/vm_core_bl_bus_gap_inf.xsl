	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Business Change Analysis - Information Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Business Change Analysis - Information Gap</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<p>To inform stakeholders regarding the extent of change that is required to move the business from the baseline state to the target state.</p>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<p>A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Business Architecture models and the Target Business Architecture models. This view focuses on Information Gaps - change to the information requirements of a department.</p>
							</div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/bus_gap_information_MM.png" alt="Business Change Analysis - Information Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										...
										<tr>
											...
											<td class="textColourRed">Information Used</td>
											<td>Details the CRUD</td>
										</tr>
										<tr>
											...
											<td>Populate with Information Views and associated Business Processes</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>Populated with Information Views</td>
										</tr>
										<tr>
											<td>&#160;</td>
											<td>&#160;</td>
											<td class="textColourRed">Business Logical Elements </td>
											<td>Populated with Business Processes</td>
										</tr>
										<tr>
					...
					<div id="sectionGap">
						...
						<div class="col-xs-12">
							...
							<div>
								<br/>
								<img src="view_manual/vm_images/bus_gap_information_SS.png" alt="Business Change Analysis - Information Gap" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
