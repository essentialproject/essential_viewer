	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Application Change Analysis - Application Interface Gap</title>
			</head>
			<body>
						...
						<div>
							<div class="col-xs-12">
								<div class="page-header">
									<h1>
										...
										<span class="text-darkgrey">Application Change Analysis - Application Interface Gap</span>
									</h1>
								</div>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="sectionIcon">
										...
										<p>A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Architecture models and the Target Architecture models.</p>
										<p>This view focuses on the Application Interface Gap. The application interface gap is informed by Application Distribution Model.</p>
									</div>
								</div>
								...
								<div class="col-xs-12">
									<div class="sectionIcon">
										...
										<br/>
										<img src="view_manual/vm_images/app_gap_app_interface_MM.png" alt="Application Change Analysis - Application Interface Gap Meta-Model"/>
									</div>
								</div>
								...
								<div class="col-xs-12">
									<div class="sectionIcon">
										...
										<table class="table table-bordered table-striped ">
											...
											<tbody>
												<tr>
													<td>:System Class/ :Relation/ :Directed Binary Relation/ :EA Graph Relation/ :Application Relationships/ :APA-STATIC-RELATION </td>
													<td>:APU-TO-APU-STATIC-RELATION</td>
													<td>&#160;</td>
													<td>This relation is the dependencies between the Application Providers in the Static Application Provider Architecture. See Note 1</td>
												</tr>
												<tr>
													...
													<td>Populate with :APU-TO-APU-STATIC-RELATION</td>
												</tr>
												<tr>
												...
												<tr>
													<td class="textColourRed">Application logical Elements</td>
													<td>Populated with :APU-TO-APU-STATIC-RELATION</td>
												</tr>
												<tr>
							...
							<div class="col-xs-12">
								<div class="sectionIcon">
									...
									<br/>
									<img src="view_manual/vm_images/app_gap_app_interface_SS.png" alt="Application Change Analysis - Application Interface Gap" class="screenshotFrame"/>
								</div>
							</div>
