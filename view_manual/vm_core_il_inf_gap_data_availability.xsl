	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Information Change Analysis - Data Availability Gap</title>
			</head>
			<body>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="page-header">
								<h1>
									...
									<span class="text-darkgrey">Information Change Analysis - Data Availability Gap</span>
								</h1>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">A model that indicates the deficiencies and opportunities for improvement that is derived from a comparison between the Baseline Data Architecture models and the Target Data Architecture models. This view focuses on Data Availability Gaps – where data is not available to the right systems or at required location. This view is informed by the Data-Application Model. </div>
							<hr/>
						</div>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								...
								<br/>
								<img src="view_manual/vm_images/inf_gap_data_avail_MM.png" alt="Information Change Analysis - Data Availability Gap Meta-Model"/>
							</div>
							<hr/>
						</div>
								...
								<table class="table table-bordered table-striped ">
									...
									<tbody>
										...
										<tr>
											...
											<td rowspan="5">Information Strategic Plan</td>
											<td class="textColourRed">Strategic Plan for Elements </td>
											<td>Populate with Data Objects</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>Populated with Data Objects</td>
										</tr>
										<tr>
						...
						<div class="col-xs-12">
							...
							<div class="content-section">
								<br/>
								<img src="view_manual/vm_images/inf_gap_data_avail_SS.png" alt="Information Change Analysis - Data Availability Gap" class="screenshotFrame"/>
							</div>
							<hr/>
						</div>
