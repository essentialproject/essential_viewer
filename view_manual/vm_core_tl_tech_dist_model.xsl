	...
	<xsl:template match="pro:knowledge_base">
		...
		<html>
			<head>
				...
				<title>View Manual: Technology Distribution Model</title>
			</head>
			<body>
						...
						<div>
							<div class="col-xs-12">
								<div class="page-header">
									<h1>
										...
										<span class="text-darkgrey">Technology Distribution Model</span>
									</h1>
								</div>
								...
								<div class="col-xs-12">
									...
									<div class="content-section">To define the distribution of technology components for a distributed operating environment that will reduce duplication and optimise the re-use of shared infrastructure whilst providing optimal access channels to information intensive services to the intended users. </div>
								</div>
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<div class="content-section">A model that defines the technologies in different locations/environments. </div>
								</div>
								...
								<div class="col-xs-12">
									<div class="sectionIcon">
										...
										<br/>
										<img src="view_manual/vm_images/tech_dist_model_MM.png" alt="Technology Distribution Model Meta-Model"/>
									</div>
								</div>
								...
								<div class="col-xs-12">
									<div class="sectionIcon">
										...
										<h4>Setup Notes</h4>
										<p>For this view to navigate the meta model successfully the Report Constant must be defined. To complete the set-up follow these steps:-</p>
										<ol>
											<li>Define and create the root Technology Composite for your organisation.</li>
											<li>Navigate to EA Support/Essential Viewer/Report Constant and select the Technology Distribution Model class.</li>
											<li>Click ADD in the Associated Instances slot and select the root Technology Composite that has been created.</li>
										</ol>
										<div class="verticalSpacer_10px"/>
										<h4>Note 1</h4>
										...
										<ol>
											...
											<li>Select ADD in the CLASSIFIED AS field and navigate to TECHNOLOGY COMPONENT USAGE TYPE and select either primary or secondary. Secondary should be used where the technology component used belongs to a different Technology Composite, otherwise use Primary.</li>
							...
							<div class="col-xs-12">
								<div class="sectionIcon">
									...
									<br/>
									<img src="view_manual/vm_images/tech_dist_model_SS.png" alt="Technology Distribution Model" class="screenshotFrame"/>
								</div>
							</div>
