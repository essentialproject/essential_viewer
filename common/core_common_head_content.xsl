...
-->
	<xsl:template match="node()" name="commonHeadContent">
		...
		<xsl:if test="$currentLanguage/own_slot_value[slot_reference = 'right_to_left_text']/value = 'true'">
			<link rel="stylesheet" href="css/essential_rtl.css?release=6.19" type="text/css"/>
		</xsl:if>
		<link rel="stylesheet" href="user/custom.css?release=6.19" type="text/css"/>
		<!--Standard JQuery Library-->
		<script type="text/javascript" src="js/jquery/jquery.min.js?release=6.19"/>
		...
		<script type="text/javascript" src="js/context-menu/jquery.contextMenu.js?release=6.19"/>
		<!--script to support the feedback page-->
		<script src="js/feedbackformmailer.js?release=6.19" type="text/javascript"/>
		<!--JQuery plugin to support vertical align within divs-->
		<script type="text/javascript" src="js/jquery.verticalalign.js?release=6.19"/>
		<!--Bootstrap JS library-->
		<script type="text/javascript" src="js/bootstrap-3.4.1-dist/js/bootstrap.min.js?release=6.19"/>
		<!--Match Height Library-->
		<script src="js/jquery.matchHeight.js?release=6.19" type="text/javascript"/>
		<script src="js/select2/js/select2.full.min.js?release=6.19"/>
		<!-- Handlebars templating library -->
		<script src="js/handlebars/handlebars.min.js?release=6.19"/>
		<!-- Date formatting library -->
		<script src="js/moment/moment.js?release=6.19"/>
		<!--Help text and tour library-->
		<script src="js/hopscotch/js/hopscotch.min.js?release=6.19"/>
		...
		<link rel="stylesheet" href="css/essential-core.css?release=6.19" type="text/css"/>
