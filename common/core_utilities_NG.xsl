...
<xsl:stylesheet exclude-result-prefixes="pro xalan xs functx eas fn easlang" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:eas="http://www.enterprise-architecture.org/essential" xmlns:xalan="http://xml.apache.org/xslt" xmlns:pro="http://protege.stanford.edu/xml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:functx="http://www.functx.com" xpath-default-namespace="http://protege.stanford.edu/xml" xmlns:easlang="http://www.enterprise-architecture.org/essential/language">
	...
	<xsl:include href="core_menu_NG.xsl"/>
	...
	<xsl:param name="utilitiesAllMenusApi"/>
	<xsl:param name="utilitiesAllReportTypesApi"/>
	<xsl:param name="utilitiesAllReportsApi"/>
	<xsl:param name="utilitiesAllPDFConfigsApi"/>
	<xsl:param name="utilitiesAllReportConstantsApi"/>
	<xsl:param name="utilitiesAllLanguagesApi"/>
	<xsl:param name="utilitiesAllEditorsApi"/>
	<xsl:param name="utilitiesAllEditorSectionsApi"/>
	<xsl:param name="utilitiesAllDataSetAPIsApi"/>
	<xsl:param name="utilitiesAllTaxonomyTermsApi"/>
	<xsl:param name="utilitiesAllSynonymsApi"/>
	<xsl:param name="utilitiesAllCommentariesApi"/>
	<xsl:param name="utilitiesAllElementStylesApi"/>
	<eas:apiRequests>
		
		{
		"apiRequestSet": [
			{
				"variable": "utilitiesAllMenusApi",
				"query": "/instances/type/Report_Menu"
			},
			{
				"variable": "utilitiesAllReportTypesApi",
				"query": "/instances/type/Report_Implementation_Type"
			},
			{
				"variable": "utilitiesAllReportsApi",
				"query": "/instances/type/Report"
			},
			{
				"variable": "utilitiesAllPDFConfigsApi",
				"query": "/instances/type/Report_PDF_Configuration"
			},
			{
				"variable": "utilitiesAllReportConstantsApi",
				"query": "/instances/type/Report_Constant"
			},
			{
				"variable": "utilitiesAllLanguagesApi",
				"query": "/instances/type/Language"
			},
			{
				"variable": "utilitiesAllEditorsApi",
				"query": "/instances/multiple_types?type=Editor&amp;type=Simple_Editor&amp;type=Configured_Editor"
			},
			{
				"variable": "utilitiesAllEditorSectionsApi",
				"query": "/instances/type/Editor_Section"
			},
			{
				"variable": "utilitiesAllDataSetAPIsApi",
				"query": "/instances/type/Data_Set_API"
			},
			{
				"variable": "utilitiesAllTaxonomyTermsApi",
				"query": "/instances/type/Taxonomy_Term"
			},
			{
				"variable": "utilitiesAllSynonymsApi",
				"query": "/instances/type/Synonym"
			},
			{
				"variable": "utilitiesAllCommentariesApi",
				"query": "/instances/multiple_types?type=Commentary&amp;type=Label"
			},
			{
				"variable": "utilitiesAllElementStylesApi",
	...
	<xsl:variable name="utilitiesAllMenus" select="$utilitiesAllMenusApi//simple_instance"/>
	<xsl:variable name="utilitiesAllReportTypes" select="$utilitiesAllReportTypesApi//simple_instance"/>
	<xsl:variable name="utilitiesAllReports" select="$utilitiesAllReportsApi//simple_instance"/>
	<xsl:variable name="utilitiesAllPDFConfigs" select="$utilitiesAllPDFConfigsApi//simple_instance"/>
	<xsl:variable name="utilitiesAllReportConstants" select="$utilitiesAllReportConstantsApi//simple_instance"/>
	<xsl:variable name="utilitiesAllLanguages" select="$utilitiesAllLanguagesApi//simple_instance"/>
	<xsl:variable name="utilitiesAllEditors" select="$utilitiesAllEditorsApi//simple_instance"/>
	<xsl:variable name="utilitiesAllEditorSections" select="$utilitiesAllEditorSectionsApi//simple_instance"/>
	<xsl:variable name="utilitiesAllDataSetAPIs" select="$utilitiesAllDataSetAPIsApi//simple_instance"/>
	<xsl:variable name="utilitiesAllTaxonomyTerms" select="$utilitiesAllTaxonomyTermsApi//simple_instance"/>
	<xsl:variable name="utilitiesAllSynonyms" select="$utilitiesAllSynonymsApi//simple_instance"/>
	<xsl:variable name="utilitiesAllCommentaries" select="$utilitiesAllCommentariesApi//simple_instance"/>
	<xsl:variable name="utilitiesAllElementStyles" select="$utilitiesAllElementStylesApi//simple_instance"/>
	...
	<xsl:variable name="defaultLanguageReportConstant" select="$utilitiesAllReportConstants[own_slot_value[slot_reference = 'name']/value = 'Default Language']"/>
	...
	<xsl:variable name="enabledReportLanguages" select="$utilitiesAllLanguages[own_slot_value[slot_reference = 'rl_is_enabled']/value = 'true']"/>
	<xsl:variable name="enabledLanguages" select="$utilitiesAllLanguages[name = $enabledReportLanguages/own_slot_value[slot_reference = 'rl_language']/value]"/>
...
<!--	<xsl:variable name="utilitiesAllEditors" select="/node()/simple_instance[type = ('Editor', 'Simple_Editor', 'Configured_Editor')]"/>-->
	...
	<xsl:template match="node()" mode="RenderObjectiveTaxonomyTerm">
		<xsl:variable name="theInstanceID" select="current()"/>
		<xsl:variable name="aTerm" select="$utilitiesAllTaxonomyTerms[name = $theInstanceID]"/>
...
-->
	...
	<xsl:function name="eas:get_instance_by_name" as="node()*">
		...
		<xsl:sequence select="$inScopeInstances[(type = $thisType) and (own_slot_value[slot_reference = 'name']/value = $name)]"/>
	</xsl:function>
