...
<xsl:stylesheet version="2.0" xpath-default-namespace="http://protege.stanford.edu/xml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xslt" xmlns:pro="http://protege.stanford.edu/xml" xmlns:eas="http://www.enterprise-architecture.org/essential" xmlns:functx="http://www.functx.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ess="http://www.enterprise-architecture.org/essential/errorview">
	...
	<xsl:param name="allModalRepoVersionsXML"/>
	<xsl:param name="essAllModalReportsXML"/>
	<xsl:param name="essAllModalDataSetAPIInstsXML"/>
	<xsl:param name="modalIdeationConstantInstXML"/>
	...
	<eas:apiRequests>
		
		{
			"apiRequestSet": [
				{
				"variable": "allModalRepoVersionsXML",
				"query": "/instances/type/Meta_Model_Version"
				},
				{
				"variable": "essAllModalReportsXML",
				"query": "/instances/type/Modal_Report?modal_report_is_enabled=true"
				},
				{
				"variable": "essAllModalDataSetAPIInstsXML",
				"query": "/instances/type/Data_Set_API"
				},
				{
				"variable": "modalIdeationConstantInstXML",
	...
	<xsl:variable name="allModalRepoVersions" select="$allModalRepoVersionsXML//simple_instance"/>
	<xsl:variable name="essAllModalReports" select="$essAllModalReportsXML//simple_instance"/>
	<xsl:variable name="essAllModalDataSetAPIInsts" select="$essAllModalDataSetAPIInstsXML//simple_instance"/>
	<xsl:variable name="modalIdeationConstantInst" select="$modalIdeationConstantInstXML//simple_instance"/>
	
	
	<xsl:variable name="modalRepoVersion" select="$allModalRepoVersions[1]/own_slot_value[slot_reference = 'meta_model_version_id']/value"/>
	...
	<xsl:variable name="essAllModalDataSetAPIs" select="$essAllModalDataSetAPIInsts[name = $essAllModalReports/own_slot_value[slot_reference = 'modal_report_content_apis']/value]"/>
	...
	<xsl:template name="RenderModalReportContent">
		...
		<xsl:variable name="modalIdeationConstant" select="$modalIdeationConstantInst/own_slot_value[slot_reference = 'report_constant_value']/value"/>
