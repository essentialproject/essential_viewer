...
<xsl:stylesheet version="2.0" xpath-default-namespace="http://protege.stanford.edu/xml" exclude-result-prefixes="pro xalan" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xslt" xmlns:pro="http://protege.stanford.edu/xml" xmlns:eas="http://www.enterprise-architecture.org/essential">
	<!--
	...
	<xsl:param name="allHeaderViewStylingXML"/>
	...
	<eas:apiRequests>
		
		{
			"apiRequestSet": [
				{
				"variable": "allHeaderViewStylingXML",
	...
	<xsl:variable name="allHeaderViewStyling" select="$allHeaderViewStylingXML//simple_instance"/>

	<xsl:import href="core_utilities_NG.xsl"/>
	<xsl:import href="datatables_includes.xsl"/>
	<xsl:key name="allstyles_key" match="$allHeaderViewStyling" use="own_slot_value[slot_reference = 'style_is_active']/value"/>
...
-->
	<xsl:template match="node()" name="commonHeadContent">
		...
		<link rel="stylesheet" href="js/bootstrap-3.4.1-dist/css/bootstrap.min.css?release=6.18" type="text/css"/>
		<link rel="stylesheet" href="js/context-menu/jquery.contextMenu.min.css?release=6.18" type="text/css"/>
		<link rel="stylesheet" href="fonts/font-awesome-4.7.0/css/font-awesome.min.css?release=6.18" type="text/css"/>
		<link href="js/select2/css/select2.min.css?release=6.18" rel="stylesheet"/>
		<link href="js/select2/css/select2-bootstrap.min.css?release=6.18" rel="stylesheet"/>
		<link href="js/hopscotch/css/ess-hopscotch.css?release=6.18" rel="stylesheet"/>
		
		<link href="fonts/source-sans/source-sans-pro.css?release=6.18" rel="stylesheet" type="text/css"/>
		<xsl:if test="$currentLanguage/own_slot_value[slot_reference = 'right_to_left_text']/value = 'true'">
			<link rel="stylesheet" href="css/essential_rtl.css?release=6.18" type="text/css"/>
		</xsl:if>
		<link rel="stylesheet" href="user/custom.css" type="text/css"/>
		<!--Standard JQuery Library-->
		<script type="text/javascript" src="js/jquery/jquery.min.js?release=6.18"/>
		<!--Custom JQuery UI library to support various visual effects-->
		<script type="text/javascript" src="js/jquery-ui/jquery-ui.min.js?release=6.18"/>
		...
		<!-- file saver library -->
		<script type="text/javascript" src="js/FileSaver.min.js?release=6.18"/>
		<!--JQuery plugin to support popup menus for link navigation-->
		<script type="text/javascript" src="js/context-menu/jquery.contextMenu.js?release=6.18"/>
		<!--script to support the feedback page-->
		<script src="js/feedbackformmailer.js?release=6.18" type="text/javascript"/>
		<!--JQuery plugin to support vertical align within divs-->
		<script type="text/javascript" src="js/jquery.verticalalign.js?release=6.18"/>
		<!--Bootstrap JS library-->
		<script type="text/javascript" src="js/bootstrap-3.4.1-dist/js/bootstrap.min.js?release=6.18"/>
		...
		<script src="js/hopscotch/js/hopscotch.min.js?release=6.18"/>
		...
		<link rel="stylesheet" href="css/essential-core.css?release=6.18" type="text/css"/>
