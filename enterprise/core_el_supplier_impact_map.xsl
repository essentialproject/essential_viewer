...
-->
    ...
    <xsl:variable name="supplierKPI" select="$utilitiesAllDataSetAPIs[own_slot_value[slot_reference = 'name']/value = 'Core: Support KPIs'][1]"></xsl:variable>
    ...
    <xsl:variable name="techProdSuppData" select="$utilitiesAllDataSetAPIs[own_slot_value[slot_reference = 'name']/value = 'Core API: Application Mart'][1]"></xsl:variable>
