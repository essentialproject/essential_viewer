      ...
      <html>
         ...
         <body>
                  ...
                  <div class="col-xs-12">
                     ...
                     <div class="tab-content">
                        <div id="coach" class="tab-pane fade in active">
                           <form id="eaForm" action="">
                              <!-- One "tab" for each step in the form: -->
                              <div class="tab">
                                 <div class="question-section"><h3>What is the level of engagement of management?</h3></div>
                                 <select id="engaged" class="custom-select form-control"> 
                                    <option class="option"  value="H">High</option>
                                    <option class="option"  selected="true"  value="M">Medium</option>
                                    <option class="option"  value="L">Low</option>
                              ...
                              <div class="tab">
                                 <div class="question-section"><h3>What is the key driver for EA currently?</h3></div>
                                 <select id="driver" class="custom-select form-control"> 
                                    <option class="option"  value="Risk">Risk</option>
                                    <option class="option"  value="Efficiency">Cost Efficiency</option>
                                    <option class="option"  selected="true" value="Rationalisation">Rationalisation</option>
                                    <option class="option"  value="Alignment">Strategy Alignment</option>
                                    <option class="option"  value="Model">Business Model Change</option>
                                    <option class="option"  value="Digital">Digital Business Transformation</option>
                                    <option class="option"  value="NA">Don't know</option>
                                 </select>
                              </div>
                              
                              <div class="tab">	
                                 <div class="question-section"><h3>Do you have good working relationship with the business, i.e. people who you can work with to deliver elements of the EA?</h3></div>
                              ...
                              <div class="tab">	
                                 <div class="question-section"><h3>Do you have good engagement within IT, some scepticism or a bit of both?</h3></div>
                                 <select id="itinterest" class="custom-select form-control"> 
                                    <option class="option"  selected="true" value="Good">Good</option>
                                    <option class="option"  value="Bad">Not good</option>
                                    <option class="option"  value="mixed">Mixed</option>
                                 </select>
                              </div>	
                              <div class="tab">
                                 <div class="question-section">
                                    <h3>How would you describe your maturity</h3>
                                    <ol>
                                 ...
                                 <select id="maturity" class="custom-select form-control"> 
                                    <option class="option"  selected="true" value="1">Level 1</option>  
                                    <option class="option"  value="2">Level 2</option>  
                                    <option class="option"  value="3">Level 3</option>
                                    <option class="option"  value="4">Level 4</option> 
                                    <option class="option"  value="5">Level 5</option>
                                 </select>
                              </div>		
                              ...
                              <div class="tab">
                                 <div class="question-section">
                                    <h3>Do you have a business capability model defined?</h3>
                                 </div>
                              ...
                              <div class="tab">
                                 <div class="question-section">
                                    <h3>Do you have a business processes defined and linked to applications?</h3>
                                 </div>
                              ...
                              <div class="tab">		
                                 <div class="question-section">
                                    <h3>Do you have a list of applications?</h3>
                                 </div>
                              ...
                              <div class="tab">			
                                 <div class="question-section"><h3>Do you have access to application costs?</h3></div>
                                 <select id="costaccess" class="custom-select form-control"> 
                                    <option class="option"   value="Y">Yes</option>
                                    <option class="option"  selected="true"  value="N">No</option> 
                                 </select>
                              </div>	
                              <div class="tab">		
                                 <div class="question-section"><h3>Do you have a list of technologies used?</h3></div>
                              ...
                              <div class="tab">			
                                 <div class="question-section"><h3>Do you have access to technology costs?</h3></div>
                              ...
                              <div  class="tab">
                                 <div class="question-section"><h3>Do you have access to vendor technology Lifecycles?</h3></div>
                              ...
                              <div class="tab">
                                 <div class="question-section"><h3>Do you have standards defined?</h3></div>
                              ...
                              <div class="tab">
                                 <div class="question-section"><h3>Do you have strategic plans/roadmaps defined?</h3></div>
                              ...
                              <div class="tab">
                                 <div class="question-section"><h3>Do you have a project portfolio?</h3></div>
                              ...
                              <div class="tab">
                                 <div class="question-section"><h3>What is the current credibility of EA in the organisation?</h3></div>
                                 <select id="credibility" class="custom-select form-control">  
                                    <option class="option"  value="1">None</option>  
                                    <option class="option"  value="2">Low</option>  
                                    <option class="option"  selected="true" value="3">OK</option>
                                    <option class="option"  value="4">High</option> 
                                    <option class="option"  value="5">Very High</option>
                                 </select> 
                              </div>	
                        ...
                        <div id="launchpad" class="tab-pane fade">
                           ...
                           <div class="col-md-6  ">
                              <button id="genExcel" class="btn btn-sm btn-success pull-right top-10">Generate Launchpad File</button>
                           </div>
            ...
            <script>
               ...
               if ($(this).text() == 'Submit') {
               //sendFacts();
               let ruleSetName = "rules.ruleset1";
               let facts = {
