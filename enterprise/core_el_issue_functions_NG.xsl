...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:eas="http://www.enterprise-architecture.org/essential" xmlns:xalan="http://xml.apache.org/xslt" xmlns:pro="http://protege.stanford.edu/xml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:functx="http://www.functx.com" xpath-default-namespace="http://protege.stanford.edu/xml" xmlns:easlang="http://www.enterprise-architecture.org/essential/language">
	...
	<xsl:param name="allIssuesXML"/>
	<xsl:param name="allIssueCategpriesXML"/>
	<xsl:param name="allIssueImpactsXML"/>
	<xsl:param name="allIssueRelatedBusElementsXML"/>
	<xsl:param name="allIssueRelatedAppElementsXML"/>
	<xsl:param name="allIssueRelatedInfoDataElementsXML"/>
	<xsl:param name="allIssueRelatedTechElementsXML"/>
	<xsl:param name="allIssueMitigatingPlansXML"/>
  <eas:apiRequests>
		{
			"apiRequestSet": [
				{
				"variable": "allIssuesXML",
				"query": "/instances/type/Issue"
				},
				{
				"variable": "allIssueCategpriesXML",
				"query": "/instances/type/Issue_Category"
				},
				{
				"variable": "allIssueImpactsXML",
				"query": "/instances/multiple_types?type=Requirement_Impact&amp;type=Service_Quality"
				},
				{
				"variable": "allIssueRelatedBusElementsXML",
				"query": "/instances/supertype/Business_Layer/slots"
				},
				{
				"variable": "allIssueRelatedAppElementsXML",
				"query": "/instances/supertype/Application_Layer/slots"
				},
				{
				"variable": "allIssueRelatedInfoDataElementsXML",
				"query": "/instances/supertype/Information_Layer/slots"
				},
				{
				"variable": "allIssueRelatedTechElementsXML",
				"query": "/instances/supertype/Technology_Layer/slots"
				},
				{
				"variable": "allIssueMitigatingPlansXML",
				"query": "/instances/supertype/Strategic_Plan/slots"
				} 
			]
		}
	</eas:apiRequests>

	<xsl:variable name="allIssues" select="$allIssuesXML//simple_instance"/>
	<xsl:variable name="allIssueCategpries" select="$allIssueCategpriesXML//simple_instance[name = $allIssues/own_slot_value[slot_reference = 'issue_categories']/value]"/>
	<xsl:variable name="allIssueImpacts" select="$allIssueImpactsXML//simple_instance[name = $allIssues/own_slot_value[slot_reference = 'issue_impact']/value]"/>
	<xsl:variable name="allIssueRelatedBusElements" select="$allIssueRelatedBusElementsXML//simple_instance[name = $allIssues/own_slot_value[slot_reference = 'related_business_elements']/value]"/>
	<xsl:variable name="allIssueRelatedAppElements" select="$allIssueRelatedAppElementsXML//simple_instance[name = $allIssues/own_slot_value[slot_reference = 'related_application_elements']/value]"/>
	<xsl:variable name="allIssueRelatedInfoDataElements" select="$allIssueRelatedInfoDataElementsXML//simple_instance[name = $allIssues/own_slot_value[slot_reference = 'related_information_elements']/value]"/>
	<xsl:variable name="allIssueRelatedTechElements" select="$allIssueRelatedTechElementsXML//simple_instance[name = $allIssues/own_slot_value[slot_reference = 'related_technology_elements']/value]"/>
	...
	<xsl:variable name="allIssueMitigatingPlans" select="$allIssueMitigatingPlansXML//simple_instance[name = $allIssues/own_slot_value[slot_reference = 'resolved_by']/value]"/>
